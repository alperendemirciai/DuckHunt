...
public class Level3 extends Application {
     ...
     * This level includes 2 ducks flying horizontally and 6 bullets.
     ...
     */
    public Level3(Image crosshairSelected, Image backgroundSelected,Image foregroundSelected) throws URISyntaxException {
        ...
        duckFirst = new DuckPane(backgroundSelected,"red");
    ...
    /**
     * This method is called to start the Level3 scene.
    ...
    public void displayWin(Stage primaryStage){
        ...
        levelScene.setOnKeyPressed(event -> {
            if (event.getCode() == KeyCode.ENTER) {
                ...
                audioClipWin.stop();
                try {
                    new Level4(crosshairSelected,backgroundSelected,foregroundSelected).start(primaryStage);
                } catch (Exception ex) {
