...
public class Level5 extends Application {
    ...
    /**
     * Constructor for the Level 5
     * This level includes 3 ducks (2 flying horizontally , 1 flying diagonally) and 9 bullets.
     ...
     */
    public Level5(Image crosshairSelected, Image backgroundSelected,Image foregroundSelected) throws URISyntaxException {
    ...
    /**
     * This method is called to start the Level5 scene.
    ...
    public void displayWin(Stage primaryStage){
        ...
        levelScene.setOnKeyPressed(event -> {
            if (event.getCode() == KeyCode.ENTER) {
                ...
                audioClipWin.stop();
                try {
                    new Level6(crosshairSelected,backgroundSelected,foregroundSelected).start(primaryStage);
                } catch (Exception ex) {
