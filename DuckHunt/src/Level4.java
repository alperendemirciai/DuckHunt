...
public class Level4 extends Application {
    ...
    /**
     * Constructor for the Level 4
     * This level includes 2 ducks flying diagonally and 6 bullets.
     ...
     */
    public Level4(Image crosshairSelected, Image backgroundSelected,Image foregroundSelected) throws URISyntaxException {
    ...
    /**
     * This method is called to start the Level4 scene.
    ...
    public void start(Stage primaryStage) throws Exception {
        ...
        ducks.getChildren().addAll(duckFirst.getDuckPane(),duckSecond.getDuckPane());
    ...
    public void displayWin(Stage primaryStage){
        ...
        levelScene.setOnKeyPressed(event -> {
            if (event.getCode() == KeyCode.ENTER) {
                ...
                audioClipWin.stop();
                try {
                    new Level5(crosshairSelected,backgroundSelected,foregroundSelected).start(primaryStage);
                } catch (Exception ex) {
