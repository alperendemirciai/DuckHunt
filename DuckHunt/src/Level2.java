...
public class Level2 extends Application {
    ...
    /**
     * Constructor for the Level 2
     * This level includes 1 duck flying diagonally and 3 bullets.
     ...
     */
    public Level2(Image crosshairSelected, Image backgroundSelected,Image foregroundSelected) throws URISyntaxException {
        ...
        duckFirst = new DuckPane(backgroundSelected,"blue");
        //set the ducks position to the right bottom corner
        duckFirst.setDuckY((backgroundSelected.getHeight()* DuckHunt.SCALE)-duckFirst.getDuckHeight());
        duckFirst.setDuckX((backgroundSelected.getWidth()* DuckHunt.SCALE)-duckFirst.getDuckWidth());
    ...
    /**
     * This method is called to start the Level2 scene.
    ...
    public void displayWin(Stage primaryStage){
        ...
        levelScene.setOnKeyPressed(event -> {
            if (event.getCode() == KeyCode.ENTER) {
                ...
                audioClipWin.stop();
                try {
                    new Level3(crosshairSelected,backgroundSelected,foregroundSelected).start(primaryStage);
                } catch (Exception ex) {
